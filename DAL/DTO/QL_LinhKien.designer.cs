...
namespace DTO
{
    ...
    partial void InsertCTDONNHAP(CTDONNHAP instance);
    partial void UpdateCTDONNHAP(CTDONNHAP instance);
    partial void DeleteCTDONNHAP(CTDONNHAP instance);
    #endregion
		
		public QL_LinhKienDataContext() : 
				base(global::DTO.Properties.Settings.Default.QL_THIETBIConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<CTDONNHAP> CTDONNHAPs
		{
			get
			{
				return this.GetTable<CTDONNHAP>();
			}
		}
	}
	...
	public partial class THIETBI : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntitySet<CTDONNHAP> _CTDONNHAPs;
    ...
    partial void OnTINHTRANGChanged();
		...
		public THIETBI()
		{
			...
			this._CTDONNHAPs = new EntitySet<CTDONNHAP>(new Action<CTDONNHAP>(this.attach_CTDONNHAPs), new Action<CTDONNHAP>(this.detach_CTDONNHAPs));
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_TINHTRANG", DbType="NVarChar(130)")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="THIETBI_CTDONNHAP", Storage="_CTDONNHAPs", ThisKey="MATB", OtherKey="MATB")]
		public EntitySet<CTDONNHAP> CTDONNHAPs
		{
			get
			{
				return this._CTDONNHAPs;
			}
			set
			{
				this._CTDONNHAPs.Assign(value);
			}
		}
		...
		private void attach_CTDONNHAPs(CTDONNHAP entity)
		{
			this.SendPropertyChanging();
			entity.THIETBI = this;
		}
		
		private void detach_CTDONNHAPs(CTDONNHAP entity)
		{
			this.SendPropertyChanging();
			entity.THIETBI = null;
		}
    ...
    partial void OnGHICHUChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONNHAP_CTDONNHAP", Storage="_CTDONNHAPs", ThisKey="MADN", OtherKey="MADN")]
		public EntitySet<CTDONNHAP> CTDONNHAPs
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.CTDONNHAP")]
	public partial class CTDONNHAP : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnTHANHTIENChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DONNHAP_CTDONNHAP", Storage="_DONNHAP", ThisKey="MADN", OtherKey="MADN", IsForeignKey=true)]
			...
			set
			{
							...
							|| (this._DONNHAP.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((previousValue != null))
					{
						...
						previousValue.CTDONNHAPs.Remove(this);
					}
					this._DONNHAP.Entity = value;
					if ((value != null))
					{
						value.CTDONNHAPs.Add(this);
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="THIETBI_CTDONNHAP", Storage="_THIETBI", ThisKey="MATB", OtherKey="MATB", IsForeignKey=true)]
		public THIETBI THIETBI
		{
			get
			{
